...
# === CONFIG ===
PARCELLES_FILE = Path("parcelles.json")       # ton JSON d'entrée avec parcelles
SIREN_FILE = Path("sirens1.txt")               # liste de siren extraits
ENTREPRISES_FILE = Path("entreprisesaregarder2.json")   # JSON sauvegardé des réponses API
OUTPUT_XLSX = Path("fusion_finale101.xlsx")      # Excel final fusionné
